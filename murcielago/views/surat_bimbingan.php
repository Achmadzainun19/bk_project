    ...
    <section class="content">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form method="post" action="<?php echo base_url('p/surat_bimbingan/ac') ?>">
      ...
      <div class="box">
        ...
        <div class="box-header with-border">
          ...
          <h3 class="box-title">Surat Bimbingan Siswa</h3>
            ...
            <tbody>
              ...
              $no++;
               ...
               <tr>
                 ...
                 <td><?php echo $count_poin->total ?></td>

                 <td> 
                 <a href="<?php echo base_url('p/begin_surat_bimbingan/'.$l->id_siswa.'') ?>" class="btn btn-danger btn-flat" name="button">Proses</a>
