    ...
    <section class="content">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form method="post" action="<?php echo base_url('p/konseling/ac') ?>">
      ...
      <div class="box">
        ...
        <div class="box-header with-border">
          ...
          <h3 class="box-title">Konseling Siswa</h3>
            ...
            <tbody>
              ...
              $no++;
               ...
               <tr>
                 ...
                 <td> 
                 <a href="<?php echo base_url('p/begin_konseling/'.$l->id_siswa.'') ?>" class="btn btn-danger btn-flat" name="button">Proses</a>
